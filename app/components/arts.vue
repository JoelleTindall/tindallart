...
switch (props.for) {
  case "dana":
    ...
    arts = [
      ...
      { src: 'Orange_Popsicle_2024_Mixed_media_18x7x4.jpeg', name: 'Orange Popsicle', description: 'Mixed_media_18x7x4', artist: props.for },
      { src: 'Pancakes, 2025,  10”x 9”x3.5” Mixed media.jpeg', name: 'Pancakes', description: '10”x 9”x3.5” Mixed media', artist: props.for },
  ...
  case "karen":
    arts = [
      { src: 'Arches-2025-4_X4.5_-acrylic and prismacolor on paper.jpg', name: 'Arches', description: '4_X4.5_-acrylic and prismacolor on paper', artist: props.for },
      { src: 'Canyonlands-2025-4.5_X5.5_ acrylic and prismacolor on paper.jpg', name: 'Canyonlands', description: '4.5_X5.5_ acrylic and prismacolor on paper', artist: props.for },
      { src: 'Cloudscape with barn-2025-5_X5_ gouache on paper.jpg', name: 'Cloudscape with Barn', description: '5_X5_ gouache on paper', artist: props.for },
      { src: 'Cloudscape-2025-4.75_X5_-gouache on paper.jpg', name: 'Cloudscape', description: '4.75_X5_-gouache on paper', artist: props.for },
      { src: 'Jewelry Box-2025-4_X6_ acrylic on canvas.jpg', name: 'Jewlery Box', description: '4_X6_ acrylic on canvas', artist: props.for },
      { src: 'N-Letters from Jack-2025-5_X5_ gouache on paper.jpg', name: 'N - Letters from Jack', description: '5_X5_ gouache on paper', artist: props.for },
      { src: 'Q-Letters from Jack-2025-5_X5_ gouache on paper.jpg', name: 'Q - Letters from Jack', description: '5_X5_ gouache on paper', artist: props.for },
      { src: 'S-Letters from Jack-2025-5_X5_-gouache on paper.jpg', name: 'S - Letters from Jack', description: '5_X5_ gouache on paper', artist: props.for },
      { src: 'September 18 2024-2024-4_X4_ acrylic on canvas.jpg', name: 'September 18 2024', description: '4_X4_ acrylic on canvas', artist: props.for },
      { src: 'Utah Moonrise-2025-13_X8_ acrylic and prismacolor on paper.jpg', name: 'Utah Moonrise', description: '13_X8_ acrylic and prismacolor on paper', artist: props.for },
      { src: 'Window Tint-2025-4_X6_ acrylic on canvas.jpg', name: 'Window Tint', description: '4_X6_ acrylic on canvas', artist: props.for },
      { src: 'Yard Art-2025-4_X6_ acrylic on canvas.jpg', name: 'Yard Art', description: '4_X6_ acrylic on canvas', artist: props.for },
    ];
    break;
};
